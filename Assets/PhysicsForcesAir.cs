...
public class PhysicsForcesAir : MonoBehaviour
{
    [Header("Mass")] [SerializeField] private float mass = 1;

    [SerializeField] private float gravity = -9.8f;
    [SerializeField] [Range(0, 1)] private float frictionCoeficiente = 2000;
    ...
    void AirFriction()
    {
        ...
        {
            Vector3 frictionVector = -1 * frictionCoeficiente * weight.magnitude * velocity.normalized;
            ApplyForce(frictionVector);
        }
    }
